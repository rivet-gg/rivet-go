...
func (c *Client) GetDirectThread(ctx context.Context, identityId uuid.UUID) (*chat.GetDirectThreadResponse, error) {
	baseURL := "https://chat.api.rivet.gg/v1"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"identities/%v/thread", identityId)
	...
	var response *chat.GetDirectThreadResponse
